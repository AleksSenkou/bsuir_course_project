...
ActiveRecord::Schema.define(version: 20150531104858) do
  ...
  add_index "options", ["lesson_id"], name: "index_options_on_lesson_id", using: :btree
  ...
  add_index "pictures", ["advert_id"], name: "index_pictures_on_advert_id", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "name"
    t.boolean  "signup_with_provider",   default: false
